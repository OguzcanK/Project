...
<div class="col-sm-8 blog-main">
    ...
    <div class="blog-post">
        ...
        <a href="index.php?pageid=17&option=1">forgot Username</a> -
        <a href="index.php?pageid=17&option=2">forgot Password</a> -
        <a href="index.php?pageid=17&option=3">forgot Username and Password</a>
        <!-- END BLOCK : LOGINFORM -->
